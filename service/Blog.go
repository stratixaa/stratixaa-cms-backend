...
func CreateBlog(ctx context.Context, blog models.BlogPost) (*mongo.InsertOneResult, error) {
	blog.Status = "draft"
...
func UpdateBlog(ctx context.Context, blog models.BlogPost, id primitive.ObjectID) (*models.BlogPost, error) {
...
func GetBlogByID(ctx context.Context, id primitive.ObjectID) (*models.BlogPost, error) {
...
func GetAllBlogs(ctx context.Context, limit, offset int64, search, category, status string) ([]models.BlogPost, int64, error) {
